...
(coalton-toplevel
  ...
  (declare raw-classical-arg (classical:Arg :num -> ClassicalArg))
  (define (raw-classical-arg arg)
    (match arg
      ((classical:Ref name loc)
       (lisp ClassicalArg (name loc) (quil:mref name loc)))
      ((classical:Const n)
       (lisp ClassicalArg (n) (quil:constant n)))))
    
  (declare raw-classical-op (classical:Operation (classical:Arg :num) -> Instruction))
  ...
  (declare raw-macro-classical-op (classical:Operation (macro:MaybeFormal (classical:Arg :num)) -> Instruction))
