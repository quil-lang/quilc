...
docker rm -f quilc-base || true
docker rm -f quilc-tests || true
docker rm $(docker ps -a -q --filter=ancestor=docker.lab.rigetti.com/qcs/quilc) || true
docker rm $(docker ps -a -q --filter=ancestor=docker.lab.rigetti.com/qcs/quilc-base) || true
...
docker rm $(docker ps -a -q --filter=ancestor=quilc-base) || true
